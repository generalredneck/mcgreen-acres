...
sed -i 's/<env name="SIMPLETEST_BASE_URL" value=""\/>/<env name="SIMPLETEST_BASE_URL" value="https:\/\/localhost" force="true"\/>/' /app/web/core/phpunit.xml
sed -i 's/<env name="SIMPLETEST_DB" value=""\/>/<env name="SIMPLETEST_DB" value="mysql:\/\/drupal11:drupal11@database\/drupal11" force="true"\/>/' /app/web/core/phpunit.xml
sed -i 's/<env name="BROWSERTEST_OUTPUT_BASE_URL" value=""\/>/<env name="BROWSERTEST_OUTPUT_BASE_URL" value="https:\/\/localhost" force="true"\/>/' /app/web/core/phpunit.xml
...
sed -i 's/<env name="BROWSERTEST_OUTPUT_DIRECTORY" value=""\/>/<env name="BROWSERTEST_OUTPUT_DIRECTORY" value="\/app\/web\/sites\/simpletest\/browser_output\/" force="true"\/>/' /app/web/core/phpunit.xml
