...
/**
 * Class ParagraphCloneForm contains clone form for paragraph entity type.
 */
class ParagraphCloneForm extends ContentEntityForm {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    $destination_entity_type = $form_state->getValue([
      'paragraphs_edit',
      'entity_type',
    ]);
    $destination_entity_id = $form_state->getValue([
      'paragraphs_edit',
      'parent',
    ]);
