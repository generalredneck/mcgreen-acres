...
class MaxLengthCkeditorTest extends WebDriverTestBase {
  ...
  public function testCkeditor5() {
    ...
    // Check that maxlength counters change according to text even when
    // switching text format from full_html to basic_html and back.
    ...
    do {
      ...
      $page->selectFieldOption('foo[0][format]', $format);
      ...
      $this->assertNotEmpty($this->assertSession()->waitForElement('css', '.ck-editor'));
    } while ($formats);
