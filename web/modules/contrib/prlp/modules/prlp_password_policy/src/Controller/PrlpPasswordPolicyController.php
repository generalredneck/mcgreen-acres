...
namespace Drupal\prlp_password_policy\Controller;

use Drupal\user\Controller\UserController;
use Symfony\Component\HttpFoundation\Request;

/**
 * Controller for prlp password policy form.
 */
class PrlpPasswordPolicyController extends UserController {

  /**
   * {@inheritDoc}
   */
  public function prlpPasswordPolicyGetResetPassForm(Request $request, $uid) {
