...
class SubscriptionManager implements SubscriptionManagerInterface {
  ...
  public function hasSubscribed(string $mail, string $newsletter_id) {
    $found = $this->entityTypeManager->getStorage('simplenews_subscriber_history')->getQuery()
      ->condition('mail', $mail)
  ...
  public function trackHistory(SubscriberInterface $subscriber) {
    ...
    $this->entityTypeManager->getStorage('simplenews_subscriber_history')->create($values)->save();
  }
  ...
  public function tidy() {
    ...
    $subscriber_storage = $this->entityTypeManager->getStorage('simplenews_subscriber');
    $subscriber_storage->delete($subscriber_storage->loadMultiple($unconfirmed));
  }
