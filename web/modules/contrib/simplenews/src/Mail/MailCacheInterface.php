...
interface MailCacheInterface {
   ...
   * implementations are responsible to create a unique cache key themselves
   * using the $mail. For example based on the node id and the language.
   *
   ...
   * Although group and key can be used to identify the requested cache, the
   * implementations are responsible to create a unique cache key themselves
   * using the $mail. For example based on the entity id and the language.
   *
   * @param \Drupal\simplenews\Mail\MailInterface $mail
   *   The mail object.
   * @param string $group
