...
/**
 * Default Mailer that sends newsletter and subscription mails.
 */
class Mailer implements MailerInterface {
  ...
  public function sendSubscribeConfirmation(SubscriberInterface $subscriber) {
    ...
    $message = $this->mailManager->mail('simplenews', $key, $subscriber->getMail(), $subscriber->getLangcode(), $params, $params['from']['address']);
