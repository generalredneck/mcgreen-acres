...
class ShipmentSubscriber implements EventSubscriberInterface {
   ...
   * @param \Drupal\commerce_shipping\Mail\ShipmentConfirmationMailInterface $shipmentConfirmationMail
   *   The shipment confirmation mail service.
   */
  public function __construct(
    protected EntityTypeManagerInterface $entityTypeManager,
    protected ShipmentConfirmationMailInterface $shipmentConfirmationMail,
  ) {
  }
   ...
   */
  public function onShip(WorkflowTransitionEvent $event): void {
   ...
   *   The shipment event.
   */
  public function onShipmentDelete(ShipmentEvent $event): void {
   ...
   */
  protected function clearShipments(): void {
