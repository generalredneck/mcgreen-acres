        ...
        if ($entity instanceof EntityInterface) {
          ...
          if (static::$recursiveRenderDepth[$recursive_render_id] > static::RECURSIVE_RENDER_LIMIT) {
            ...
            try {
              ...
              // The counter only needs to track genuine recursion within a
              // single top-level render (this entity embedding itself down
              // the tree). Once this render has completed, release the slot
              // so unrelated, sequential top-level renders of the same
              // entity within one request (e.g. simplenews rendering a
              // newsletter body once per recipient) don't exhaust the limit
              // and falsely trigger the recursion guard.
              // @see https://www.drupal.org/node/3416529
              static::$recursiveRenderDepth[$recursive_render_id]--;
            }
          }
        }
