...
class WebformMailChimpHandler extends WebformHandlerBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['mailchimp']['token_tree_link'] = $this->buildTokenTreeElement();
  ...
  public function postSave(WebformSubmissionInterface $webform_submission, $update = TRUE) {
    ...
    $configuration = $this->replaceTokens($this->configuration, $webform_submission);
    ...
    if (!empty($configuration['list']) && !empty($email)) {
      ...
      mailchimp_subscribe($configuration['list'], $email, array_filter($mergevars), $configuration['interest_groups'], $double_optin, 'html', NULL, FALSE, $tags);
    }
    else {
